...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let cmdutil = client.commands.filter(command => (command.category || '').toLowerCase() === "utility").array();
    let cmdfun = client.commands.filter(command => (command.category || '').toLowerCase() === "fun").array();
    let cmdmod = client.commands.filter(command => (command.category || '').toLowerCase() === "moderation").array();
